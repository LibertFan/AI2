...
class Caesar1(ReflexCaptureAgent):
    ...
    def getWeights(self, gameState, action):
	return {'teammateDist': 7.8977938803987335, 'closest-food': -11.666080484089136, 'eats-capsules': 12.270276003309094,
                '#-of-dangerous-ghosts-1-step-away': -23.004574472869237, 'eats-ghost': 3.833080980780451, 
